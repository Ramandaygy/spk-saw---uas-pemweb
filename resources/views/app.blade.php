    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="{{ url('alternatif') }}"><strong>ALTERNATIF</strong></a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="{{ url('kriteria') }}"><strong>KRITERIA</strong></a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="{{ url('nilai') }}"><strong>NILAI</strong></a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="{{ url('hitung') }}"><strong>PERHITUNGAN</strong></a>
                </li>
            </ul>
